                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: AppDimensions.height10*2.8,),
                      inner_text("Reason 2"),
                      Container(
                        padding:  EdgeInsets.only(left: AppDimensions.height10*2.0,right:AppDimensions.height10*23.6 ),
                        child: Row(
...
class _inner_textState extends State<inner_text> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding:  EdgeInsets.only(top: AppDimensions.height10*2, bottom: 1, left:AppDimensions.height10*2, right: AppDimensions.height10*2.0),
      decoration: BoxDecoration(
      ...
      Container(
        ...
        width:AppDimensions.height10* 32.0,
         child: CupertinoTextField(
              placeholder: "I want to achieve this goal to be in control of my anger and to regain control of my life.",
...
FloatingActionButton add_reason = FloatingActionButton(
  ...
  shape: RoundedRectangleBorder(
      side:  BorderSide(width: AppDimensions.height10*0.3, color: Colors.white),
