          ...
          child: Stack(
            children: [
              Align(
                ...
                child: Container(
                  width: AppDimensions.width10(BuildContext) *
                      6.5,
                  height:
                  AppDimensions.height10(BuildContext) *
                      6.5,
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                    ...
                    fontSize:
                    AppDimensions.font10(BuildContext) * 2.0,
                    fontWeight: FontWeight.w600),
              ),
              Text(
                missed? 'Session missed':'Session completed',
                style: TextStyle(
                    color:missed? const Color(0xffEB5757): const Color(0xff156F6D),
                    height: 1.2,

                    overflow: TextOverflow.ellipsis,
                    fontSize:
                    AppDimensions.font10(BuildContext) * 1.8,
                    fontWeight: FontWeight.w600),
              ),
            ],
          ),
