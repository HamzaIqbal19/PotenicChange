...
class MulitiSelectionButton extends StatefulWidget {
  final Widget child;
  final Function onTap;
  final Duration duration;
  final Function longPress;

  const MulitiSelectionButton({
    super.key,
    required this.child,
    required this.onTap,
    this.duration = const Duration(milliseconds: 50),
  ...
  @override
  _MulitiSelectionButtonState createState() => _MulitiSelectionButtonState();
}

class _MulitiSelectionButtonState extends State<MulitiSelectionButton>
    with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  bool _ignorePointer = false;
