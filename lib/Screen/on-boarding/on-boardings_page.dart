...
class OnboardingPageState extends State<OnboardingPage> {
  ...
  Widget _indicator(bool isActive) {
    return AnimatedContainer(
      ...
      padding: EdgeInsets.only(left:AppDimensions.height10,right: AppDimensions.height10),
      ...
      decoration: BoxDecoration(
        ...
        borderRadius:
            BorderRadius.all(Radius.circular(AppDimensions.height10)),
      ),
    );
  }
  ...
  Widget _showPageData(OnboardingModel page, int i) {
    ...
    return Container(
      decoration: BoxDecoration(
       ...
       padding: EdgeInsets.only(top: AppDimensions.height10*4.9),
      child: Column(
        ...
        children: <Widget>[
          ...
          SizedBox(height: AppDimensions.height10*3.8),
          Center(
            child: Image(
              // color: Colors.orange,
          ...
          page.description2 !=""?SizedBox(height: AppDimensions.height10*5.45):SizedBox(height: AppDimensions.height10*7.64),
          Container(

            height: page.description2 !=""?AppDimensions.height10 * 3.6:AppDimensions.height10 * 8.2,
          ...
          Container(
            ...
            height: page.description2 != "" ? AppDimensions.height10*12.4: AppDimensions.height10*32.9,
            child: Text(
              page.description,
              textAlign: TextAlign.center,
              style: TextStyle(
          ...
          page.description2 != " " ? SizedBox(height: AppDimensions.height10*2.1):Container(),
          page.image1 != ""
              ? Center(
                  child: Image(
          ...
          page.image2 != ""
              ...
              : Container(),
          page.description2 != " " ? SizedBox(height: AppDimensions.height10*5.3): SizedBox(height: AppDimensions.height10*6.1),
          Row(
