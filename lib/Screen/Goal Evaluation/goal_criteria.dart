      ...
      onWillPop: () {
        if (saved == false) {
          ...
          Navigator.push(context,
              FadePageRoute(page: const new_progress_score(premium: true)));
                ...
                onPressed: () {
                  if (saved == false) {
                    ...
                    Navigator.push(
                        context,
                        FadePageRoute(
                            page: const new_progress_score(premium: true)));
                  }
                },
                icon: Image.asset(
                                      ...
                                      children: [
                                        Text(
                                          widget.destination == 'reason'
                                              ...
                                              : widget.destination ==
                                                      'identityStatement'
                                                  ? goalDetails['goalEvaluations'][0]["newIdentity"]
                                                              .toString() ==
                                                          "null"
                                                      ? '-'
                                                      : goalDetails['goalEvaluations'][0]
                                                              ...
                                                              children: [
                                                                ...
                                                                Container(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () {
                                                                      var sum = selectedItemIndexesOuter!.reduce(
                                                                          (a, b) =>
                                                                              a +
                                                                              b);
                                                                      print(sum +
