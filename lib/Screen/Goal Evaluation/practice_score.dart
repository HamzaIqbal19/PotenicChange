...
class _prac_scoreState extends State<prac_score> {
  ...
  void getPracticeEval() {
    PracticeEvaluation.getPracticeEvaluation().then((response) {
      ...
      if (response.length != 0) {
        setState(() {
          selectedItemIndex = response['question1'];
          selectedItemIndex2 = response['question2'];
          selectedItemIndex3 = response['question3'];
          selectedItemIndex4 = response['question4'];
        });
      }
      print(
                                                                        ...
                                                                        PracticeEvaluation()
                                                                          ...
                                                                          if (response.length !=
                                                                            ...
                                                                            Navigator.push(context,
                                                                                FadePageRoute(page: prac_score(saved: true)));
