                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            width: AppDimensions.height10(context) * 32.7,
                            height: AppDimensions.height10(context) * 14.6,
                            //color: Colors.amber,
                            margin: EdgeInsets.only(
                    ...
                    child: Stack(children: [
                      ...
                      Align(
                        ...
                        child: GestureDetector(
                          onTap: () {},
                          child: Container(
                            height: AppDimensions.height10(context) * 13.245,
                            width: AppDimensions.height10(context) * 13.23,
                            decoration: const BoxDecoration(
                                //color: Colors.amber,
                                image: DecorationImage(
                                    image: AssetImage(
                  ...
                  SizedBox(
                      ...
                      child: Center(
                        child: Text('4',
                            style: TextStyle(
                                fontFamily: 'Poppins',
                                fontSize: AppDimensions.height10(context) * 9.6,
                                fontWeight: FontWeight.w300,
                                color: const Color(0xFFFBFBFB),
                                height:
                                    AppDimensions.height10(context) * 0.12)),
                      ...
                      child: Row(children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                height: AppDimensions.height10(context) * 8.253,
                                margin: EdgeInsets.only(
                                    bottom:
                                        AppDimensions.height10(context) * 0.68),
                                decoration: const BoxDecoration(
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              Container(
                                width: AppDimensions.height10(context) * 6.75,
                                height: AppDimensions.height10(context) * 6.687,
                                margin: EdgeInsets.only(
                                    bottom:
                                        AppDimensions.height10(context) * 1.49,
                                    top: AppDimensions.height10(context) *
                                        2.736),
                                decoration: const BoxDecoration(
                                    image: DecorationImage(
                              ...
                              Container(
                                ...
                                height: AppDimensions.height10(context) * 5.41,
                                margin: EdgeInsets.only(
                    ...
                    child: Center(
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: AppDimensions.height10(context) * 3.0,
                            fontWeight: FontWeight.w700,
                            letterSpacing: AppDimensions.height10(context) * 0,
                            color: const Color(0xFFFBFBFB),
                            height: AppDimensions.height10(context) * 0.12),
                      ),
                    ),
