              ...
              children: [
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        // width:   AppDimensions.height10(context)(context)* 23.8,
                      ...
                      SizedBox(
                        // width:   AppDimensions.height10(context)(context)* 23.8,
                        height: AppDimensions.height10(context) * 3.35,
                        child: Text(
                ...
                SizedBox(
                  ...
                  child: Divider(
                    ...
                    //thickness:   AppDimensions.height10(context)(context)* 0.5,
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Column(children: [
          Container(
            // width:   AppDimensions.height10(context)(context)* 41.1,
            height: AppDimensions.height10(context) * 5.1,
            // margin: EdgeInsets.only(top:   AppDimensions.height10(context)(context)* 5.4),
            decoration: BoxDecoration(
          ...
          Container(
            height: AppDimensions.height10(context) * 76.0,
            width: double.infinity,
            color: Colors.white,
            child: Column(
              children: [
        ...
        child: Column(
          children: [
            Container(
              ...
              height: AppDimensions.height10(context) * 5.1,
              margin:
                  EdgeInsets.only(top: AppDimensions.height10(context) * 5.4),
              decoration: BoxDecoration(
                  color: const Color(0xffF5F5F5).withOpacity(0.8),
                  borderRadius: BorderRadius.only(
