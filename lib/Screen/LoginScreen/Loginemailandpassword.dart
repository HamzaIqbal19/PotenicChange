            ...
            body:  Stack(
              children: <Widget>[
                ...
                Column(
                  ...
                  children:<Widget> [
                    SizedBox(height:AppDimensions.height10 * 8.2,),
                    Center(
                      ...
                      child:Column(
                        ...
                        children: [
                          ...
                          Container(
                              ...
                              decoration: BoxDecoration(color: Colors.white, border: Border.all(color: Colors.white, width: 2), borderRadius:  BorderRadius.all(Radius.circular(AppDimensions.height10*1.8))),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Container(
                                    margin: EdgeInsets.only(left:AppDimensions.height10*2.0,bottom: AppDimensions.height10*0.5),
                                  ...
                                  Container(
                                    margin: EdgeInsets.only(left:AppDimensions.height10*2.0,),
                                    width: AppDimensions.height10*20.9,
                                    height: AppDimensions.height10*2.2,
                                    child: TextFormField(decoration: const InputDecoration(contentPadding:EdgeInsets.zero,floatingLabelBehavior: FloatingLabelBehavior.always,hintText:"JohnSmith@yahoo.com",focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.transparent)),enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.transparent)))),
                                  )
                                ],
                              )
                          ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              Container(
                              margin: EdgeInsets.only(left:AppDimensions.height10*2.0,),
                              width: AppDimensions.height10*6.7,
                              height: AppDimensions.height10*2.2,
                                                         child: TextFormField(decoration: const InputDecoration(contentPadding:EdgeInsets.zero,floatingLabelBehavior: FloatingLabelBehavior.always,hintText:"********",focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.transparent)),enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.transparent)))),
                              )
                              ],
                            )
                          ),
