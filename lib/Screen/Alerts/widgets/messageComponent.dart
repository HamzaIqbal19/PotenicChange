    ...
    child: Stack(children: [
      ...
      Container(
        margin: EdgeInsets.only(
          top: UpdatedDimensions.height10(context) * 2.7,
          left: UpdatedDimensions.width10(context) * 2.5,
        ),
        child: Column(
...
alertBox(
  ...
  return showAnimatedDialog(
      ...
      builder: (BuildContext context) => SizedBox(
            ...
            height: AppDimensionsUpdated.height10(context) * 21.4,
            child: AlertDialog(
              ...
              title: Container(
                  margin: EdgeInsets.only(
                      ...
                      right: AppDimensionsUpdated.width10(context) * 1.6,
                      left: AppDimensionsUpdated.width10(context) * 1.6,
                      bottom: AppDimensionsUpdated.height10(context) * 1.2),
                  ...
                  child: RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: const [
                            ...
                            TextSpan(text: 'this alert?')
                          ]))),
              content: Container(
                margin: EdgeInsets.only(
                    bottom: AppDimensionsUpdated.height10(context) * 1.5,
                    left: AppDimensionsUpdated.height10(context) * 1.6,
                    right: AppDimensionsUpdated.height10(context) * 1.6),
