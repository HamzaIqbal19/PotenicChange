...
class _MessageCenterState extends State<MessageCenter> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                margin:
                    EdgeInsets.only(top: AppDimensionsUpdated.height10(context) * 1.9),
                child: Center(
                  child: Text(
                    'Message centre',
                    style: TextStyle(
              ...
              Container(
                ...
                margin:
                    EdgeInsets.only(top: AppDimensionsUpdated.height10(context) * 1.2),
                child: Center(
                  child: Text(
              ...
              notifications.length == 0?noMessages(context):  ListView.builder(
                ...
                return MulitiSelectionButton(
                  onTap: (){
                    if(options){
                      setState(() {
                        if(deleteIds.contains(notifications[index]["id"])){
                          deleteIds.remove(notifications[index]["id"]);
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      options == true?  Positioned(
                        top:22,
                        right: 27,
                        child: checkBox(context, deleteIds.contains(notifications[index]["id"])),
                      ):const SizedBox()
                    ],
                  ),
                );
              }),
              SizedBox(height: AppDimensionsUpdated.height10(context)*6,)
            ],
          ),
        ),
      ),
      ...
      // )
      //     :
      (isLoading == true || notifications.length == 0)?Container(): AnimatedScaleButton(
            onTap: (){
              setState(() {
                options = true;
              });
            ...
            child: Container(
                ...
                margin: options
                    ...
                    : EdgeInsets.only(
                        ...
                        bottom: AppDimensionsUpdated.height10(context) * 2.2),
                ...
                child: options
                    ? Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              alertBox(context,() {
                                ...
                                ,
                            child: Container(
                              width: AppDimensionsUpdated.width10(context) * 10.1,
                          ...
                          Container(
                            width: AppDimensionsUpdated.width10(context) * 7.7,
